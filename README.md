...
4.1 Чем отличается колоночный формат хранения данных от строчного? - колончатый занимает меньше места, процессы агригации происходят быстрее, но чтение и запись 
медленнее
